...
int main(int argc, char *argv[]) {
   ...
   fcfs(s1, s2, iNumb[2], iNumb[3], iNumb[4], iNumb[5], iNumb[6], iNumb[7]);
   ...
   sjf(s1, s2, iNumb[2], iNumb[3], iNumb[4], iNumb[5], iNumb[6], iNumb[7]);
   // Calling display function
   display(heading, s1, s2);
   ...
   //Heading that will be printed
   heading = "PSJF\n";
   // Calling PSJF function
   psjf(s1, s2, iNumb[2], iNumb[3], iNumb[4], iNumb[5], iNumb[6], iNumb[7]);
   // Calling display function
   display(heading, s1, s2);
   ...
   heading = "RR\n";
   // Calling RR function
   rr(s1, s2, iNumb[1], iNumb[2], iNumb[3], iNumb[4], iNumb[5], iNumb[6], iNumb[7]);
   // Calling display function
   display(heading, s1, s2);
